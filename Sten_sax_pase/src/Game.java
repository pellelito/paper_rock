...
public class Game {
	...
	public static void main(String[] args) {
	     ...
	     String playerChoice = scanner.nextLine().toUpperCase().replace(" ", ""); // Plockar bort ev mellanslag och omvandlar till uppercase på inmatning

	     	if (playerChoice.equals("Q")) {											//Kollar om man valt att sluta
	    	 System.out.println("\nGame exited");
	    	 break;}
	     	if (playerChoice.equals("1")){playerChoice = "ROCK";} 						//kollar omman valt att spela med siffror istället för text
	     	if (playerChoice.equals("2")){playerChoice = "PAPER";}
	     	if (playerChoice.equals("3")){playerChoice = "SCISSORS";} 
	     	System.out.println("\nYou've chosen: " + playerChoice);
	     	if (playerChoice.equals("ROCK") || playerChoice.equals("PAPER") || playerChoice.equals("SCISSORS")) {
	            generateOutcome(generateCPUChoice(), playerChoice);  			// genererar först datorns val testar sedan denna mot spelarens val
	     	}else {
...
private static void generateOutcome(String cpuChoice, String playerChoice) {				// kollar vem som vann eller om det blev oavgjort
